...
public class ButtonScript : MonoBehaviour
{
    ...
    public IEnumerator Clicked()
    {
        ...
        for (int i = 0; i < 80; i++)
        {
            ...
            startTransform.position += new Vector3(30, 0, 0);
            archiveTransform.transform.position += new Vector3(-30, 0, 0);
            settingsTransform.transform.position += new Vector3(0, -10, 0);
            if (i <= 30)
